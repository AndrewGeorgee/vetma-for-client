...
// import 'package:vetma_final_project/presentaion/cubit/user/cubit/user_state.dart';
...
//   Stream<Doctors> getDoctorDataStream(String userId) {
//     emit(GetDoctorStreamLoading());

//     return getDoctorInfUSecase.call(userId);
//   }
